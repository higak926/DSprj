package com.DSprj.DSprj001.api.repository;
...
import com.DSprj.DSprj001.api.config.DbConfig;
...
public class CustomerMapperTest {
  ...
  public void setup() throws Exception {
    ...
    this.inputCsvDataSet =
        new CsvDataSet(new File("src/test/resources/com/DSprj/DSprj001/api/repository"));
