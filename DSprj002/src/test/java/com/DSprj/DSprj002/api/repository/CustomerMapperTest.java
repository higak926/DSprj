package com.DSprj.DSprj002.api.repository;
...
import com.DSprj.DSprj002.api.config.DbConfig;
...
public class CustomerMapperTest {
  ...
  public void setup() throws Exception {
    ...
    this.inputCsvDataSet =
        new CsvDataSet(new File("src/test/resources/com/DSprj/DSprj002/api/repository"));
